  ...
  return (
    <Container>
      <Row className="mt-3">
        <Col md="5">
          <InputGroup>
            <Input type="text" value={query} onChange={e => setQuery(e.target.value)} placeholder="Please enter a username" />
            <Button onClick={fetDetails} className="secondary">Fetch User</Button>
          </InputGroup>
